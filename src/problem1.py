...
def run_test_problem1a():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    expected = 1.135086  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = -1.364999  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([6,7], expected, test_results,
                                  format_string)
